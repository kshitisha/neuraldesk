...
class OpenRouterProvider(LLMProvider):
    """openRouter uses an OpenAI-compatible API — so we reuse the OpenAI
    client, just pointed at a different base URL with a different key.
    this is exactly why the abstraction layer exists: same interface,
...
"""
    ...
    async def stream_chat(
        ...
        try:
            ...
            raise LLMException(f"OpenRouter streaming error: {str(e)}")
